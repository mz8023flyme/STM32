...
//NRF24L01寄存器操作命令
#define READ        0x00  //读配置寄存器,低5位为寄存器地址
#define WRITE       0x20  //写配置寄存器,低5位为寄存器地址
...
#define NRF24L01_CE_PIN             GPIO_Pin_5                    /*GPIO引脚*/
                                    
#define NRF24L01_CSN_PORT           GPIOC                         /* GPIO端口 */
#define NRF24L01_CSN_CLK            RCC_APB2Periph_GPIOC        /* GPIO端口时钟 */
#define NRF24L01_CSN_PIN            GPIO_Pin_6                   /*GPIO引脚*/

#define NRF24L01_IRQ_PORT           GPIOC                         /* GPIO端口 */
#define NRF24L01_IRQ_CLK           RCC_APB2Periph_GPIOC        /* GPIO端口时钟 */
#define NRF24L01_IRQ_PIN           GPIO_Pin_4                /*GPIO引脚*/
