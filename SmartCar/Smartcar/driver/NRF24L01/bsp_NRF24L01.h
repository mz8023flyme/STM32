...
//判断 NRF24L01 是发送模式还是接受模式 使用到的引脚宏定义
#define      NRF_Judge_PORT_CLK              RCC_APB2Periph_GPIOB 
#define      NRF_Judge_APBxClock_FUN         RCC_APB2PeriphClockCmd 
#define      NRF_Judge_PORT                  GPIOB 
#define      NRF_Judge_PIN                   GPIO_Pin_9
...
#define      NRF_CE_CLK                  RCC_APB2Periph_GPIOC    
