...
#define      NRF_SPI_CE_APBxClock_FUN       RCC_APB2PeriphClockCmd
#define      NRF_SPI_CE_CLK                  RCC_APB2Periph_GPIOC    
#define      NRF_SPI_CE_PORT                 GPIOC
#define      NRF_SPI_CE_PIN                  GPIO_Pin_5

//CS(NSS)引脚 片选选普通GPIO即可
#define      NRF_SPI_CS_APBxClock_FUN       RCC_APB2PeriphClockCmd
#define      NRF_SPI_CS_CLK                  RCC_APB2Periph_GPIOC    
#define      NRF_SPI_CS_PORT                 GPIOC
#define      NRF_SPI_CS_PIN                  GPIO_Pin_6

//IRQ 引脚
#define      NRF_SPI_IRQ_APBxClock_FUN       RCC_APB2PeriphClockCmd
#define      NRF_SPI_IRQ_CLK                  RCC_APB2Periph_GPIOC    
#define      NRF_SPI_IRQ_PORT                 GPIOC
#define      NRF_SPI_IRQ_PIN                  GPIO_Pin_4
...
#define  SPI_CS_LOW()    PCout(1) = 0; //GPIO_ResetBits( NRF_SPI_CS_PORT, NRF_SPI_CS_PIN )
#define  SPI_CS_HIGH()   PCout(1) = 1; //GPIO_SetBits( NRF_SPI_CS_PORT, NRF_SPI_CS_PIN )
